      ...
      () => (tree) => {
        visit2(tree, (node) => {
          if (node?.type === "element" && node?.tagName === "figure") {
            ...
            preElement.properties["__withMeta__"] = node.children.at(0).tagName === "figurecaption";
            console.log(preElement.properties["__withMeta__"]);
...
//# sourceMappingURL=compiled-contentlayer-config-GG4IT5PP.mjs.map
